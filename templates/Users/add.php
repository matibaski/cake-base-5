...
$this->assign('header_title_top', 'New user');
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <?= $this->Form->control('password', ['class'=>'form-control', 'placeholder'=>'Your password', 'required'=>true]); ?>
                            </div>
                            <div class="form-group col-sm-6">
                                <?= $this->Form->control('password_confirm', ['type'=>'password', 'class'=>'form-control', 'placeholder'=>'Repeat your password', 'required'=>true]); ?>
                            </div>
                        </div>
                    </fieldset>
                </div>
