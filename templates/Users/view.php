...
$this->assign('header_title_top', false);
$this->assign('header_links', serialize($headerLinks));

if(!empty($user->profile->image_file)) {
	$profileImage = $user->profile->image_file;
} else {
		...
		<div class="col-12 grid-margin">
			<div class="profile-header">
				<div class="cover">
					...
					<figure>
						<img src="https://www.nobleui.com/vibrant/html/template/assets/images/profile-cover.jpg" class="img-fluid" alt="profile cover">
					</figure>
				...
				<div class="header-links">
					<ul class="links d-flex align-items-center mt-3 mt-md-0">
						<li class="header-link-item d-flex align-items-center active">
							<a class="pt-1px d-none d-md-block" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-columns mr-1 icon-md"><path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18"></path></svg> Timeline</a>
						</li>
						<li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
							<a class="pt-1px d-none d-md-block" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user mr-1 icon-md"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> About</a>
						</li>
						<li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
							<a class="pt-1px d-none d-md-block" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users mr-1 icon-md"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg> Friends <small class="text-muted">3,765</small></a>
						</li>
						<li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
							<a class="pt-1px d-none d-md-block" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-image mr-1 icon-md"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline></svg> Photos</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="card rounded">
				<div class="card-body">
					<div class="d-flex align-items-center justify-content-between mb-2">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								<a class="dropdown-item d-flex align-items-center" href="/users/edit/<?= $user->id ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 icon-sm mr-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg> <span class=""><?= __('Edit') ?></span></a>
								<a class="dropdown-item d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-git-branch icon-sm mr-2"><line x1="6" y1="3" x2="6" y2="15"></line><circle cx="18" cy="6" r="3"></circle><circle cx="6" cy="18" r="3"></circle><path d="M18 9a9 9 0 0 1-9 9"></path></svg> <span class=""><?= __('Update') ?></span></a>
								<a class="dropdown-item d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye icon-sm mr-2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg> <span class=""><?= __('View all') ?></span></a>
							</div>
						</div>
					</div>
					<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</p>
					<div class="mt-3">
						<label class="tx-11 mb-0 text-uppercase card-title">Joined:</label>
						<p class="text-muted"><?= date("d. F Y", strtotime($user->created)) ?></p>
					</div>
					<div class="mt-3">
						<label class="tx-11 mb-0 text-uppercase card-title">Lives:</label>
						<p class="text-muted"><?= $user->profile->city ?>, <?= $user->profile->country ?></p>
					</div>
					<div class="mt-3">
						<label class="tx-11 mb-0 text-uppercase card-title">Email:</label>
						<p class="text-muted"><?= $this->Html->link($user->username, 'mailto:' . $user->username) ?></p>
					</div>
					<div class="mt-3">
						<label class="tx-11 mb-0 text-uppercase card-title">Website:</label>
						<p class="text-muted">
							<?php
							if(empty($user->profile->website)) {
								echo '<i class="fas fa-times"></i>';
							} else {
								$str = $user->profile->website;
					...
					<div class="mt-3 d-flex social-links">
						<?= (!empty($user->profile->facebook)) ? $this->Html->link(
							'<i class="fab fa-facebook fa-fw"></i>',
							$user->profile->facebook,
							[
								'class' => 'btn d-flex align-items-center justify-content-center border mr-2 btn-icon',
								'escape' => false,
								'target' => '_blank'
							]
						) : '' ; ?>
						<?= (!empty($user->profile->instagram)) ? $this->Html->link(
						...
						<?= (!empty($user->profile->linkedin)) ?$this->Html->link(
				...
				<div class="col-md-12 grid-margin">
					<div class="card rounded">
						<div class="card-header">
							<div class="d-flex align-items-center justify-content-between">
								<div class="d-flex align-items-center">
									<img class="img-xs rounded-circle" src="<?= $profileImage ?>" alt="">                                                 
									<div class="ml-2">
						...
						<div class="card-body">
							...
							<img class="img-fluid" src="/img/samples/sample1.jpg" alt="">
						</div>
				...
				<div class="col-md-12">
					<div class="card rounded">
						...
						<div class="card-body">
							...
							<img class="img-fluid" src="/img/samples/sample2.jpg" alt="">
						</div>
						<div class="card-footer">
							<div class="d-flex post-actions">
								<a href="javascript:;" class="d-flex align-items-center text-muted mr-4">
						...
						<div class="card-body">
							...
							<div class="latest-photos">
								<div class="row">
									<div class="col-md-4">
										<figure>
											<img class="img-fluid" src="/img/samples/face1.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure>
											<img class="img-fluid" src="/img/samples/face2.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure>
											<img class="img-fluid" src="/img/samples/face3.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure>
											<img class="img-fluid" src="/img/samples/face4.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure>
											<img class="img-fluid" src="/img/samples/face5.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure>
											<img class="img-fluid" src="/img/samples/face6.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure class="mb-0">
											<img class="img-fluid" src="/img/samples/face7.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure class="mb-0">
											<img class="img-fluid" src="/img/samples/face8.jpg" alt="">
										</figure>
									</div>
									<div class="col-md-4">
										<figure class="mb-0">
											<img class="img-fluid" src="/img/samples/face9.jpg" alt="">
										</figure>
									</div>
								</div>
							</div>
						...
						<div class="card-body">
							...
							<div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
								<div class="d-flex align-items-center hover-pointer">
									<img class="img-xs rounded-circle" src="/img/samples/face2.jpg" alt="">                                                 
									<div class="ml-2">
										<p><?= $user->profile->first_name ?> <?= $user->profile->last_name ?></p>
							...
							<div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
								<div class="d-flex align-items-center hover-pointer">
									<img class="img-xs rounded-circle" src="/img/samples/face3.jpg" alt="">                                                 
									<div class="ml-2">
										<p><?= $user->profile->first_name ?> <?= $user->profile->last_name ?></p>
										<p class="tx-11 text-muted">12 Mutual Friends</p>
									</div>
							...
							<div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
								<div class="d-flex align-items-center hover-pointer">
									<img class="img-xs rounded-circle" src="/img/samples/face4.jpg" alt="">                                                 
									<div class="ml-2">
										<p><?= $user->profile->first_name ?> <?= $user->profile->last_name ?></p>
										<p class="tx-11 text-muted">12 Mutual Friends</p>
									</div>
							...
							<div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
								<div class="d-flex align-items-center hover-pointer">
									<img class="img-xs rounded-circle" src="/img/samples/face5.jpg" alt="">                                                 
									<div class="ml-2">
										<p><?= $user->profile->first_name ?> <?= $user->profile->last_name ?></p>
										<p class="tx-11 text-muted">12 Mutual Friends</p>
									</div>
							...
							<div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
								<div class="d-flex align-items-center hover-pointer">
									<img class="img-xs rounded-circle" src="/img/samples/face6.jpg" alt="">                                                 
									<div class="ml-2">
										<p><?= $user->profile->first_name ?> <?= $user->profile->last_name ?></p>
										<p class="tx-11 text-muted">12 Mutual Friends</p>
									</div>
							...
							<div class="d-flex justify-content-between">
								<div class="d-flex align-items-center hover-pointer">
									<img class="img-xs rounded-circle" src="/img/samples/face7.jpg" alt="">                                                 
									<div class="ml-2">
										<p><?= $user->profile->first_name ?> <?= $user->profile->last_name ?></p>
										<p class="tx-11 text-muted">12 Mutual Friends</p>
									</div>
