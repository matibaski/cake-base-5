											...
											<tr>
												<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;">
																			...
																			<tbody>
																				<tr>
																					<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;">
																						...
																						<h5 align="center" class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 20px; line-height: 24px;"><strong>Hello, <?= $name ?>!</strong></h5>
													...
													<table bgcolor="transparent" border="0" cellpadding="0" cellspacing="0" class="table-unstyled text-muted" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%; color: #ffffff;">
														<tbody>
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;"><?= $settings['company_name'] ?></td>
															...
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;"><?= $settings['company_address'] ?></td>
															...
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;"><?= $settings['company_zip'] ?> <?= $settings['company_city'] ?>, <?= $settings['company_country'] ?></td>
