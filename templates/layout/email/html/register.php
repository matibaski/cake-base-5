...
<body style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; margin: 0; padding: 0; border: 0;">
	<div class="preview" style="display: none; max-height: 0px; overflow: hidden;">
		<?= __('Please activate your new profile') ?>
	</div>
	<table class="base body" style="outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0; padding: 0; border: 0; background-color:#4e73df;">
		<tbody>
			<tr>
				<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" valign="top">
					<table border="0" cellpadding="0" cellspacing="0" class="container" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
						<tbody>
							<tr>
								<td align="center" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0; padding: 0 16px;">
									...
									<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 600px; margin: 0 auto;">
										<tbody>
											<tr>
												<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;">
													<table align="center" border="0" cellpadding="0" cellspacing="0" class="mx-auto" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; margin: 0 auto;">
														<tbody>
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;">
																	<table border="0" cellpadding="0" cellspacing="0" class="s-4 w-100" style="width: 100%;">
																		<tbody>
																			<tr>
																				<td align="left" height="24" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;">&nbsp;</td>
																			</tr>
																		</tbody>
																	</table><img class="" height="43" src="http://cakebase5.me/img/logo.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;" width="176">
																	<table border="0" cellpadding="0" cellspacing="0" class="s-3 w-100" style="width: 100%;">
																		<tbody>
																			<tr>
																				<td align="left" height="16" style="border-spacing: 0px; border-collapse: collapse; line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;">&nbsp;</td>
																			</tr>
																		</tbody>
																	</table>
																</td>
													...
													<table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="card" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; width: 100%; overflow: hidden;">
														<tbody>
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0;">
																	<div style="border-top-width: 5px; border-top-color: #000000; border-top-style: solid;">
																		<table border="0" cellpadding="0" cellspacing="0" class="card-body" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
																			<tbody>
																				<tr>
																					<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;">
																						<div>
																						<h4 align="center" class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;">Thanks for registering on Cake Base 5!</h4>
																						<div class="hr" style="width: 100%; margin: 20px 0; border: 0;">
																							<table border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%;">
																								<tbody>
																									<tr>
																										<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; margin: 0;"></td>
																									</tr>
																								</tbody>
																							</table>
																						</div>
																						<h5 align="center" class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 20px; line-height: 24px;"><strong>Hello, <?= $first_name ?>!</strong></h5>
																							...
																							<tbody>
																								<tr>
																									<td align="center" style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px; text-align: center;" valign="middle">
																										<i>If the button does not work, copy following URL and paste into browser: <br />http://cakebase5.me/users/activate/<?= $activationHash ?></i>
																									</td>
																								</tr>
																							</tbody>
																						</table>
													...
													<div align="center" class="text-center text-muted" style="color: #ffffff;">
														FAQ · Help
													</div>
													<table border="0" cellpadding="0" cellspacing="0" class="s-4 w-100" style="width: 100%;">
														<tbody>
													...
													<table bgcolor="transparent" border="0" cellpadding="0" cellspacing="0" class="table-unstyled text-muted" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse; width: 100%; max-width: 100%; color: #ffffff;">
														<tbody>
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;">© matibaski 2020</td>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;">
																	<table align="right" border="0" cellpadding="0" cellspacing="0" class="float-right" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
																		<tbody>
																			<tr>
																				<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;">
																					<table border="0" cellpadding="0" cellspacing="0" class="pl-2" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
																						<tbody>
																							<tr>
																								<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; padding-left: 8px; margin: 0;"><img class="" height="20" src="https://www.historians.org/assets/images/Social%20Share%20Images/Facebook.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;" width="20"></td>
																							</tr>
																						</tbody>
																					</table>
																				</td>
																			...
																			<tr>
																				<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;">
																					<table border="0" cellpadding="0" cellspacing="0" class="pl-2" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
																						<tbody>
																							<tr>
																								<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; padding-left: 8px; margin: 0;"><img class="" height="20" src="https://www.historians.org/assets/images/Social%20Share%20Images/Twitter.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;" width="20"></td>
																							</tr>
																						</tbody>
																					</table>
																				</td>
																	...
																	<table align="right" border="0" cellpadding="0" cellspacing="0" class="float-right" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: collapse;">
																		<tbody>
																			<tr>
																				<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;"><img class="" height="20" src="https://www.historians.org/assets/images/Social%20Share%20Images/LinkedIn.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;" width="20"></td>
																			</tr>
																		</tbody>
																	</table>
																</td>
															...
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;">Lehnisweidstrasse 38</td>
																<td align="right" class="text-right" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;">Disclaimer</td>
															</tr>
															<tr>
																<td align="left" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;">8967 Widen, Switzerland</td>
																<td align="right" class="text-right" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 12px; border-top-width: 0; border-bottom-width: 0; margin: 0;">AGBs</td>
															</tr>
														</tbody>
													</table>
													<table border="0" cellpadding="0" cellspacing="0" class="s-4 w-100" style="width: 100%;">
