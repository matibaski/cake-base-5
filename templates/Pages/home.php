...
<div class="row">
	...
	<?= $this->Base->counterCard('Earnings (Monthly)', 4000, null, 'CHF', null, 'primary', 'far fa-question-circle') ?>

	<?= $this->Base->counterCard('Earnings (Annual)', 215000, null, 'CHF', null, 'success', 'fas fa-dollar-sign') ?>
